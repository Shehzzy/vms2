            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-md-7 col-lg-10 px-lg-4 px-xl-8 d-flex flex-column py-5">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="mb-4">
                                        ...
                                        <select id="hospital" name="hospital_name" oninput="getDoctors()" class="form-select" aria-label="Default select example">
                                            <option selected value="null"> Select Hospital</option>
                                            <?php
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <select id="vaccine" name="vaccine_name" class="form-select" aria-label="Default select example">
                    ...
                    if (isset($_POST['book'])) {
                        ...
                        echo $sql = "INSERT INTO `appointment_table`(`vaccine_id`, `patient_id`, `patient_name`, `patient_email`, `patient_phone`, `hospital_id`, `days`,
                ...
                <script type="text/javascript">
                    function getDoctors() {
                        ...
                        var city = document.getElementById("hospital").value;
